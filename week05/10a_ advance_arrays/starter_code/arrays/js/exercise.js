...
console.log("Question1:" + q1 + "I am string");
...
/**
 * Question 5
 *  Using the variables from questions 2 and 4, write code that would 
 change the src of the first image on a web page to the src stored in q2 
 and the last image on a web page to the src stored in q4. For extra credit, troubleshoot why the images still don't show up.
 */

$('img[src="' + q2 + '"]').attr('src',q4)  //string vs. integer
