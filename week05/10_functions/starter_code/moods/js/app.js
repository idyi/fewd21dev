...
jQuery(document).ready(function(){
    // Create a function that runs whenever the submit button is clicked
        ...
        moodvalue = moodvalue.trim(); //this ignores extra spaces

        //Trim extra spaces //how to make this remove the extra space?
        //jQuery( "#mood" ).html( "Original String: '" + str + "'" );
        //jQuery( "#trimmed" ).html( "$.trim()'ed: '" + $.trim(str) + "'" );
        ...
        if(moodvalue == "excited" || moodvalue == "ecstatic" || moodvalue == "fantastic"){
            jQuery('.moodring > div').attr('class','excited'); //this replaces classes
        }
        
        // if the user inputs happy/good/great change the CSS class to 'happy'
        if(moodvalue == "happy" || moodvalue == "good" || moodvalue == "great"){
            jQuery('.moodring > div').attr('class','happy'); //this replaces classes
        }

        // if the user inputs bad/angry change the CSS class to 'bad'
        if(moodvalue == "bad" || moodvalue == "angry" || moodvalue == "upset"){
            jQuery('.moodring > div').attr('class','bad'); //this replaces classes
        }
});
